...
\begin{exampleth}
    Sea $\mathbb{F}_{2^4}$ el cuerpo de extensión sobre $\mathbb{F}_{2^2}$. Definimos el polinomio $g(x) = x^3 + ax^2 + 1 \in \mathbb{F}_{2^4}[x]$ y tomamos $n = 10$ como longitud del conjunto de definición. Podemos obtener el código de Goppa asociado a dicho conjunto de definición y polinomio $g$ escribiendo lo siguiente:
...
\begin{exampleth}
    \label{ex:goppa-3_3}
    Sea $\mathbb{F}_{3^6}$ el cuerpo de extensión sobre $\mathbb{F}_{3^3}$. Definimos el polinomio $g(x) = x^2 + ax + 1 + a^2 \in \mathbb{F}_{3^6}[x]$ y tomamos $n = 10$ como longitud del conjunto de definición. Obtengamos el código de Goppa asociado a dicho conjunto de definición y polinomio $g$.
