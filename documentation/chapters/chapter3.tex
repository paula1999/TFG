...
\begin{exampleth}
    Sea $\mathbb{F}_2^4$ el cuerpo de extensión sobre $\mathbb{F}_2^2$. Definimos el polinomio $g(x) = x^3 + ax^2 + 1 \in \mathbb{F}_2^4$ y tomamos $n = 10$ como longitud del conjunto de definición. Obtengamos el código de Goppa asociado a dicho conjunto de definición y polinomio $g$.
    ...
    Observamos que la longitud de este código es $10$ y la dimensión es $4$. Calculemos ahora la matriz de paridad y la matriz generadora asociada a este código.
...
\begin{exampleth}
    Sea $\mathbb{F}_3^6$ el cuerpo de extensión sobre $\mathbb{F}_3^3$. Definimos el polinomio $g(x) = x^2 + ax + 1 + a^2 \in \mathbb{F}_3^6$ y tomamos $n = 20$ como longitud del conjunto de definición. Obtengamos el código de Goppa asociado a dicho conjunto de definición y polinomio $g$.
    ...
    Observamos que la longitud de este código es $10$ y la dimensión es $6$. Calculemos ahora la matriz de paridad y la matriz generadora asociada a este código.
...
\begin{exampleth}
    Sea $\mathbb{F}_2^6$ el cuerpo de extensión sobre $\mathbb{F}_2^2$. Definimos el polinomio $g(x) = x^5 + ax^2 + 1 \in \mathbb{F}_2^6$ y tomamos $n = 30$ como longitud del conjunto de definición. Dada la palabra
    $$word := (0, 1, 0, 0, z_2, z_2 + 1, z_2, 0, 0, z_2, 0, z_2, z_2 + 1, 1, z_2 + 1) \in \mathbb{F}_2^2,$$ la podemos transformar en una palabra código del código definido por el conjunto de definición y el polinomio $g$:
    ...
    $$(0, 1, 0, 0, z_2, z_2 + 1, z_2, 0, 0, z_2, 0, z_2, z_2 + 1, 1, z_2 + 1, z_2 + 1, 0, z_2 + 1, 0, z_2, z_2, 1, 0, z_2, z_2, z_2 + 1, z_2, 0, z_2 + 1, 1).$$
\end{exampleth}
